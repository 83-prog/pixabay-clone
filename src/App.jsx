...
function App() {
  ...
  // fixed to scroll ke liye  phele state define krege //
const [ScrollVal, setScrollVal] = useState(false)

useEffect(() => {
 const handleScroll=()=>{
  if(window.scrollY>100){
   setScrollVal(true) // true pr scroll Add ho jayega 
  }else{
    setScrollVal(false)
  }
 };
 
 // function ko call bhi krna hoga //
...
<div class="logo--Fxnxa">
<div className='HeaderMainDiv'>
<div className={`HeaderContent ${ScrollVal ? "fixedHeader" : ""}`}>
<svg viewBox="0 0 120 33" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" className={`logo--JVgVN ${ScrollVal ? "Color_change" : ""}`}>
...
<div class="logoMarkSvg--sOnNX mobileOnly--1dKPe">  
  <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="logo--JVgVN dark--W2-N1">
...
<InputValue/>
  ...
  {/* <h1 style={{padding: "20px 10px 0px", margin: "0 auto", maxWidth: "1240px"}}>
     Pixal App 
     </h1> */}
